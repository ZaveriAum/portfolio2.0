      ...
      <div className={`about-container ${isVisible ? 'fade-in' : ''}`}>
        ...
        <div className="about-content">
            ...
            <div className="about-doc-links">
              <a href="https://drive.google.com/file/d/1ACeVfG4uflAqXzTJG63q44E-H5nMX9TJ/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                Resume
              </a>
              <a href="https://drive.google.com/file/d/15x2v13DcsAMyx6aBmnyWOJ4X6dd-Q8SU/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                Cover Letter
              </a>
              <a href="https://drive.google.com/file/d/1xxzuTwIb8BcnCchJHlBffedBuajwHK4C/view?usp=sharing" target="_blank" rel="noopener noreferrer">
